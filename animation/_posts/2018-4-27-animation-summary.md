...
![A block diagram of the original animation system closed loop feedback control system](/images/Revamp Summary/original system diagram.png )
...
![A block diagram of the new system's main controller](/images/Revamp Summary/control box diagram.png)
...
![A block diagram of the new system's individual valve bank controllers](/images/Revamp Summary/valve module diagram.png)
...
![A picture of the main controller's interfacing PCBA](/images/Revamp Summary/controller PCBA.jpg)
...
![A picture of a large touchscreen with a custom GUI](/images/Revamp Summary/controller GUI.jpg)
