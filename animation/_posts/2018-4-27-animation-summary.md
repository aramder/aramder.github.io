...
---
![The original animation control system with its many switches and indicators](/images/Revamp Summary/original system.jpg)
...
![Block diagram showing the original Rexroth/Gilderfluke closed-loop control architecture](/images/Revamp Summary/original system diagram.png )
...
![Block diagram of the redesigned main animation controller with touchscreen interface](/images/Revamp Summary/control box diagram.png)
...
![Block diagram showing how each valve bank module handles PID control and valve driving](/images/Revamp Summary/valve module diagram.png)
...
![Custom PCB assembly for interfacing the computer with the Gilderfluke show controller](/images/Revamp Summary/controller PCBA.jpg)
...
![12-inch industrial waterproof touchscreen displaying the custom animation control GUI](/images/Revamp Summary/controller GUI.jpg)
