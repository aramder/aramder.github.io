...
---
![G2SE unit connected to an animation system during field programming](/images/G2SE/G2SE in use.jpg)
...
![Eight 75mm slide potentiometers mounted on perfboard for precise joystick input](/images/G2SE/sliders.jpg)
...
![Completed control panel with sliders and buttons on laser-cut black acrylic](/images/G2SE/completed panel.jpg)
...
![Internal view showing USB hub, ethernet adapter, and serial converters](/images/G2SE/internal.jpg)
...
![G2SE connector panel with ethernet, RS-422, and DMX interfaces](/images/G2SE/connectors.jpg)

The rubber flaps provide some level of mitigation for dust, dirt, seeds, and other random float decorating material ingress.

![Completed G2SE in a Nanuk 904 enclosure with engraved label](/images/G2SE/G2SE.jpg)
