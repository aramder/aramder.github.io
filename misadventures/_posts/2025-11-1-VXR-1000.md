...
<a href="https://aramd.net/images/VXR_1000/lid_off.jpg"><img src="/images/VXR_1000/lid_off.jpg" alt="VXR-1000 with the enclosure open"></a>
...
<a href="https://aramd.net/images/VXR_1000/programming.png"><img src="/images/VXR_1000/programming.png" alt="Screenshot showing programming window configuration"></a>
...
## Limitations
One thing to note outright which may discount this unit for use in some application is the way that the VXR-1000 transmit control and receive CTCSS/DCS decode. The unit does not have a direct PTT input, but rather a carrier operated relay (COR) input from the mobile radio it's supposed to be paired with. If the VXR-1000 is receiving and the COR input signal goes high, it **will not transmit** until both the mobile COR and VXR-1000 receiver COR **both** go low. Unfortunately, the VXR-1000 COR activates **even without valid CTCSS/DCS decode**. This means that background noise could effectively lock out the VXR-1000's ability to transmit.

There is a workaround which may work depending on your application. Each channel has a "Sql Ofst" field which allows adjustment of the squelch. A value from 0 to 100 allows you to set the squelch higher without realigning the unit. A value from 101-255 appears to **completely deafen the receiver**. This means you'll never have to worry about the VXR-1000 COR locking out your ability to trigger the unit to transmit. This works fine for my application, but it's a pretty serious limitation for a typical commercial radio environment.
