...
My replacement keeps the same two-domain shape as Motorola's, with isolated logic on one side, coil drive on the other. The full [schematic is on github](https://github.com/aramder/orc/blob/main/hardware/orc.pdf).
