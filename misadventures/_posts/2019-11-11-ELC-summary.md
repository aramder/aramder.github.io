...
---
![3D render of the Embedded Lighting Controller motherboard with output modules](/images/ELC/motherboard top.png)
...
![Concept sketch of the modular motherboard and daughterboard architecture](/images/ELC/modular construction sketch.png)
...
![Render showing connector layout for DMX, power, and accessories on the compact enclosure](/images/ELC/motherboard connectors.png)
...
![Addressable LED module and 4-channel PWM MOSFET module renders](/images/ELC/addrLED and 4ChanPWM modules.png)
...
![Functional motherboard running from a LiPo battery during testing](/images/ELC/motherboard functional.jpg)
